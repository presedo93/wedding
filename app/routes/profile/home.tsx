...
const ProfileCard = ({ user }: { user: User }) => (
  <div className="mt-4 flex flex-row items-center gap-5 rounded-lg bg-slate-400 p-4 shadow-sm shadow-slate-500">
    <Avatar className="size-14">
      <AvatarImage src={user.pictureUrl!} alt="profile" />
      <AvatarFallback>L&R</AvatarFallback>
    </Avatar>
    <p className="mr-4 line-clamp-1 text-lg text-ellipsis">
...
const UserTasks = ({ tasks }: { tasks: Task }) => {
  ...
  return (
    <>
      ...
      <div className="mt-4 flex flex-col rounded-lg bg-slate-300 p-4 shadow-sm shadow-slate-400">
